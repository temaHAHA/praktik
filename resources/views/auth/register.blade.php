            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="checkbox" class="col-md-4 col-form-label text-md-end">{{ __('Согласие с правилами регистрации*') }}</label>

                            <div class="col-md-6">
                                <input id="checkbox" type="checkbox" class="" name="checkbox" required >
                            </div>
                        </div>
